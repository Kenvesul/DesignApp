...
function Footer() {
  return (
    <footer className="mt-auto border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 py-4 text-center text-xs text-gray-400 dark:text-gray-500">
      DesignApp v2.0 - Eurocode 7 EN 1997-1:2004 | Hansen (1970) - Craig (2004) - Blum (1931)
    </footer>
  );
}
